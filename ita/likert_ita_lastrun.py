...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/home/asus/Dropbox/personale/UNI/dottorato/ricerca/3_tesi_StOT/psychopy_likert/py_exp_psychopy_builder_ita_lenient/likert_ita_lastrun.py',
...
trials = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('resources/stimuli_ita.csv'),
...
for thisTrial in trials:
    ...
    key_resp_4.rt = []
    _key_resp_4_allKeys = []
    msg_kickout="Risposte sbagliate: "+str(kickout_count)+". Hai a disposizione altri "+str(5-kickout_count)+" tentativi."
    feedbackMsg = 'hai completato ' + str(exp_target_loop) +' frasi su ' + str(trials.nTotal) +'!'
