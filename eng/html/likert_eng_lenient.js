...
let expName = 'likert_eng_lenient';  // from the Builder filename that created this script
...
function updateInfo() {
  ...
  psychoJS.setRedirectUrls('https://app.prolific.co/submissions/complete?cc=4C61D404', '');
...
function trialsLoopBegin(trialsLoopScheduler) {
  ...
  trials = new TrialHandler({
    ...
    extraInfo: expInfo, originPath: undefined,
    trialList: 'resources/stimuli_eng.csv',
...
function trialRoutineBegin(snapshot) {
  return function () {
    ...
    _key_resp_4_allKeys = [];
    msg_kickout = (((("Wrong controls: " + kickout_count.toString()) + ". You can make ") + (5 - kickout_count).toString()) + " more mistakes.");
    
    feedbackMsg = (((("you completed " + exp_target_loop.toString()) + " tasks out of ") + trials.nTotal.toString()) + "!");
